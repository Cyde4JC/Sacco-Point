  ...
  children: [
    {
      ...
      element: (
        <GuestGuard>
          <AuthSplitLayout section={{ title: 'Hi, Welcome back', subtitle: 'Empowering Saccos!' }}>
            <Jwt.SignInPage />
          </AuthSplitLayout>
        </GuestGuard>
      ),
  ...
  children: [
    {
      ...
      element: (
        <GuestGuard>
          <AuthSplitLayout section={{ title: 'Hi, Welcome back', subtitle: 'Empowering Mobility, Ensuring Compliance – Your Fleet, Managed Smarter!' }}>
            <Amplify.SignInPage />
          </AuthSplitLayout>
        </GuestGuard>
      ),
